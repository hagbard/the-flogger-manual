...
The logger context mechanism is based on Google's [gRPC Context] API. Building logging contexts
...
4. When using the [`per(...)`] method which takes a `LogPerBucketingStrategy`, it is important 
